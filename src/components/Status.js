    ...
    return (<div className="flex flex-col w-full lg:flex-row mt-10">
        ...
        <div className="card lg:card-side bg-base-100 shadow-xl mx-10">
            ...
            <div className='p-10'>
                ...
                <p className='text-lg lg:text-xl mb-10'>Stacy will be Anita Shower's Guest on The Pismo Beach Today Show, which airs on <span className='font-semibold'>KVEC Radio 920 AM/96.5 FM radio Sunday, October 30th, 2022 at noon</span>. Tune in! You can also view a recording of my livestream down below.</p>
