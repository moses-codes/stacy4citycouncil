...
export default function Status() {
    return (<div className="flex flex-col w-full lg:flex-row mt-0 bg-white">
        ...
        <div className="card lg:card-side bg-base-100 shadow-xl mx-10 bg-white text-black mt-10">
            <img className='lg:w-2/4 w-full' src={stacy} alt='Stacy in a formal blue top.'></img>
            <div className='p-10 bg-white'>
                ...
                <p className='text-lg lg:text-xl mb-10'>Get those ballots in. You can also view a recording of Stacy's "Get-to-know" livestream from October 27 down below.</p>
