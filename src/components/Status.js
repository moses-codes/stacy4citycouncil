    ...
    return (<div className="flex flex-col w-full lg:flex-row mt-0 bg-white">
        ...
        <div className="card lg:card-side bg-base-100 shadow-xl mx-10 bg-white text-black mt-10">
            ...
            <div className='p-5 bg-white'>
                ...
                <p className='text-lg lg:text-lg mb-10 lg:w-1/2 mt-10' >Stacy and the crew will be hanging these beautiful doorhangers on houses that she wasn't able to get to. You can also view a recording of Stacy's "Get-to-know" livestream from October 27 down below.</p>
