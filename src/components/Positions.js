...
export default function Positions(props) {
    ...
    return (
        <div className='md:mt-0 xs:mt-28 pb-16 text-black bg-white' id='positions'>
            ...
            <section className={"pb-5 xl:pt-16 l:h-screen xl:flex xl:justify-center xl:mr-32 " + bpXs}>
                ...
                <FadeInSection>
                    <div className="w-2/4 pt-16 m-auto w-4/5">
                        <h2 className="font-bold pb-10 lg:text-3xl text-2xl">Stacy stands for...</h2>
                        {pageContent}
                    </div>
                </FadeInSection>
            </section>
            {/* <div className="text-center mx-auto lg:w-2/4 lg:p-5 w-full m-3 bg-slate-200 p-3 rounded-xl">
                <p className="py-3"><span className='lg:text-3xl text-xl'>"Thank you to everyone </span>who came out to the League of Women Voters Candidate forum on Thursday, October 6, 2022. Four of the Five Candidates attended the well-run event.
